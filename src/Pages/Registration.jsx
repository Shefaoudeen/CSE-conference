      ...
      <div className="w-full mt-32 max-w-3xl backdrop-blur-3xl bg-white/20 rounded-3xl shadow-2xl border border-white/30 p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input {...register("firstName", { required: true })}
                className="w-full p-3 bg-white/70 rounded-xl" placeholder="firstname" />
              {errors.firstName && <p className="text-red-400 text-xs">First name is required</p>}
            </div>

            <div>
              <label className="text-white text-sm font-medium">Last Name</label>
              <input {...register("lastName", { required: true })}
                className="w-full p-3 bg-white/70 rounded-xl" placeholder="lastname" />
              {errors.lastName && <p className="text-red-400 text-xs">Last name is required</p>}
            </div>
          </div>
          ...
          <div>
            ...
            {errors.phone && <p className="text-red-400 text-xs">Valid phone number required</p>}
          </div>
          ...
          <div className="flex justify-center">
            <ReCAPTCHA
              sitekey="6Lc3nhorAAAAAASE_nEQ62A9NOEROkLnuKWDHbeU"
