...
const Speakers = () => {
  ...
  return (
    <div className="flex mx-auto max-w-fit flex-col items-center justify-center my-20 text-white">
      ...
      <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-20">
        {speakers.map((ele, ind) => (
          <div className="flex flex-col items-center" key={ind}>
            <div className="min-w-52 min-h-52 max-w-52 max-h-52 relative rounded-full flex justify-center items-center group cursor-pointer">
              <div className="absolute bg-blue-500 w-full h-full rounded-full -z-10 -translate-x-2 -translate-y-2 shadow-lg"></div>
              <img
                src={ele.image}
                alt="Team Member Picture"
                className="absolute w-52 h-52 rounded-full border-4 border-blue-400"
              />
            </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 border mt-20 border-blue-400 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500 p-8 rounded-xl shadow-2xl max-w-3xl w-full mx-4 text-center">
