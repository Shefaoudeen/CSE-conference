...
const Speakers = () => {
  ...
  return (
    <div className="flex mx-auto max-w-fit flex-col items-center justify-center my-20">
          ...
          return (
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <p className="font-bold text-blue-700 text-xl mt-3">
                  {ele.name}
                </p>
                <p>{ele.designation}</p>
                <p>{ele.university}</p>
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 border mt-20 border-gray-400 bg-blue-700 p-8 rounded-lg shadow-lg  max-w-3xl w-full mx-4 text-center">
        ...
        <table className="text-lg border-separate border-spacing-3 text-white w-full">
          <tbody>
            {[
              ...
              <tr
                key={index}
                className="bg-black/40 border border-white/50 rounded-lg"
              >
