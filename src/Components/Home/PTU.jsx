    ...
    <div className="w-screen flex justify-center items-center">
      <div className="w-[75%] text-justify text-xl flex flex-col gap-6 leading-[28px]">
        ...
        <p>
          ...
          upon the elevation of erstwhile Pondicherry Engineering College - PEC
          (established in the year 1985 under the 7thfive-year plan)with the
          University status. NIRF, MHRD, Govt. of India has ranked the
          ...
          courses and Ph.D programmes. The National Board of Accreditation (NBA)
          of AICTE had accredited five undergraduate courses. PTU-ATAL
          ...
          Technology (DST), Council of Scientific & Industrial Research (CSIR)
          etc. through several research projects undertaken by the faculty. PTU
          has been selected by MHRD, Government of India to receive Technical
          Education Quality Improvement Programme (TEQIP) and Rashtriya
          Uchchatar Shiksha Abhiyan (RUSA) grants.{" "}
        </p>
      </div>
    </div>
  );
